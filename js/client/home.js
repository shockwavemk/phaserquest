class Home extends Phaser.Scene {
  ...
  constructor() {
    super();
    this.maxNameLength = 20; // max length of the name of the player;
  }
  ...
  makeLink(x,text,callback,hyphen){
      var color = '#b2af9b';
  ...
  makeButton(scroll,buttonY,frame,callback){
  ...
  makeScrollLink(scroll,text,callback){
